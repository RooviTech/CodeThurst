...
procedure ct_gui_controls_TSpeedButton_Create(ht: Integer; return_value: pzval;
  return_value_ptr: ppzval; this_ptr: pzval; return_value_used: Integer;
  TSRMLS_DC: pointer); cdecl;
  
procedure ct_gui_controls_TSpeedButton_LoadPicture(ht: Integer; return_value: pzval;
  return_value_ptr: ppzval; this_ptr: pzval; return_value_used: Integer;
  TSRMLS_DC: pointer); cdecl;

implementation

  procedure ct_gui_controls_TSpeedButton_Create;
    var
      Text: ppzval;
      Button: TSpeedButton;
  begin
  ...
  procedure ct_gui_controls_TSpeedButton_LoadPicture;
	    var
        ID: ppzval;
	      FileName: ppzval;
        Obj: TObject;
  ...
  begin
      ...
      TSpeedButton(AZendApi.Z_INTVAL(ID)).Glyph.Assign(bmp);
    end;
  end;
