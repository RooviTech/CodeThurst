...
type
  TCtEngine = class(TComponent, IUnknown)
  private
  protected
  public
...
procedure TCtEngine.DefineFunction(Name: PAnsiChar; CallBackFunc: pointer);
begin
  inc(RegNumFunc);
...
constructor TCtEngine.Create(AOwner: TComponent);
begin

end;

destructor TCtEngine.Destroy;
begin
  UnloadZEND;
  inherited;
end;
